pipeline {
    environment {
        registry = "temu/python-jenkins" //To push an image to Docker Hub, you must first name your local image using your Docker Hub username and the repository name that you created through Docker Hub on the web.
    ...
    stages {
        stage('checkout') {
            steps {
                git 'https://github.com/temu893/FlaskApp1.git'
            }
        }
